...
Python易于理解的语法和模块化编程方法是创建快速响应的GUI的关键，同时使整个开发过程变得轻而易举。使用Python进行GUI开发的常用工具包括：
PyQt、Tkinter、Python GTK+、wxWidgets、Kivy
...
Plotly、Matplotlib、Seaborn、Ggplot、Geoplotlib
