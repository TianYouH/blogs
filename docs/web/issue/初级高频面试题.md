...
手写深度比较，[isEqual](/web/knowledge/常用手写函数.html#isequal深度比较)

手写数组 flat ，考虑多层级 [flat](/web/knowledge/常用手写函数.html#flat数组拍平-值类型)

手写深拷贝 [deepClone](/web/knowledge/常用手写函数.html#deepclone深拷贝)

手写字符串 trim 方法，保证浏览器兼容性 [trim](/web/knowledge/常用手写函数.html#trim)
